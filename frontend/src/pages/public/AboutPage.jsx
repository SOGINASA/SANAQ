...
export function AboutPage() {
  ...
  return (
    <section className="py-16 sm:py-24"><div className="page-container">
      ...
      <div className="mt-12 rounded-4xl bg-ink p-8 text-white sm:p-12"><h2 className="font-display text-3xl font-semibold">Посмотри путь ученика вживую</h2><p className="mt-3 max-w-xl text-stone-400">Интерактивный путь сохраняет профиль, диагностику, задания и прогресс через API.</p><Button className="mt-7" onClick={() => navigate('/student/onboarding')}>Начать путь <ArrowRight className="h-5 w-5" /></Button></div>
    </div></section>
  );
}
