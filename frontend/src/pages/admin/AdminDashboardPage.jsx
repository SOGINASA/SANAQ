...
export function AdminDashboardPage() {
  ...
  const cards = [
    [Users, counts.users, t('adminDashboard.users'), t('adminDashboard.active', { count: counts.active_users }), 'bg-lavender-100 text-lavender-700'],
    [School, counts.classes, t('adminDashboard.classes'), t('adminDashboard.teachers', { count: counts.teachers }), 'bg-mint-100 text-mint-700'],
    [BookOpenCheck, counts.modules, t('adminDashboard.modules'), t('adminDashboard.published', { count: counts.published_modules }), 'bg-amber-100 text-amber-800'],
    [Bot, counts.open_ai_reports, t('adminDashboard.aiReports'), t('adminDashboard.needAttention'), 'bg-danger-100 text-danger-700'],
  ];
