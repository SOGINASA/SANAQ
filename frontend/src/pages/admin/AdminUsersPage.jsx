...
export function AdminUsersPage() {
  ...
  const createUser = async () => {
    ...
    try { await adminApi.createUser(form); setCreateOpen(false); setForm(emptyUser); setToast('Пользователь создан'); await load(); }
    catch (requestError) { setError(requestError.message); }
