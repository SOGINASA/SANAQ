...
export function AdminModerationPage() {
  ...
  const load = useCallback(async () => {
    ...
    try { const [contentResponse, reportResponse] = await Promise.all([adminApi.reviewQueue(), adminApi.aiReports()]); setContent(contentResponse.data.items || []); setReports(reportResponse.data.items || []); }
