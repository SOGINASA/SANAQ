...
export function DiagnosticPage() {
  ...
  if (loading && !question && !result) return <PageSkeleton className="max-w-3xl" layout="form" label={t('diagnostic.loading')} />;
  ...
  return <div className="mx-auto max-w-3xl py-4 sm:py-8">
    ...
    {error && <div className="state-error mt-5" role="alert">{error}</div>}
