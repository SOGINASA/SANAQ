...
export function LoginPage() {
  ...
  return <main className="grid min-h-screen bg-canvas lg:grid-cols-2">
    ...
    <div className="hero-grid hidden items-start justify-items-center overflow-hidden bg-lavender-100 px-12 pb-12 pt-28 lg:grid xl:pt-32"><div className="max-w-lg text-center"><img src={mascot} alt={t('auth.mascotAlt')} className="mascot-image mx-auto aspect-square w-[390px] rounded-full object-cover" /><p className="mt-2 font-display text-2xl font-semibold">“{t('auth.mascotQuote')}”</p></div></div>
  </main>;
}
