import { Activity, BookOpen, ChartNoAxesColumnIncreasing, ClipboardCheck, CreditCard, FileCheck2, LayoutDashboard, LibraryBig, ListChecks, Map, MessageCircleQuestion, School, Settings, ShieldCheck, Users } from 'lucide-react';
...
export const navigationItems = {
  student: [
    ...
    ['nav.achievements', '/student/achievements', ClipboardCheck], ['nav.billing', '/student/billing', CreditCard], ['nav.settings', '/student/settings', Settings],
  ],
  teacher: [
  ...
  admin: [
    ...
    ['nav.classes', '/admin/classes', School], ['nav.billing', '/admin/billing', CreditCard], ['nav.moderation', '/admin/moderation', FileCheck2], ['nav.system', '/admin/system', Activity], ['nav.audit', '/admin/audit', ShieldCheck],
