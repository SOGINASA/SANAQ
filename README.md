...
### 4. Каждый урок можно взять с собой

Уроки доступны в двух равноправных форматах: интерактивно на платформе и как брендированный **пятистраничный A4-воркбук**. В PDF есть цель, короткая теория, формулы, пошаговый алгоритм, разобранные примеры, самостоятельная практика, ответы и рефлексия. Учитель может приложить автоматически собранный воркбук к назначению или загрузить собственный PDF — ученик скачает его прямо из ленты класса.

### 5. Ученик, учитель и школа находятся в одном контуре
...
### 6. AI не получает право нарушать учебную логику
...
| Роль | Что доступно |
|---|---|
| **Ученик** | Онбординг, диагностика, персональный маршрут, полноценные уроки, интерактивные задания, A4-воркбуки, карта знаний, прогресс, достижения, интервальные повторения, AI-чат, класс и настройки доступности |
| **Учитель** | Сводка класса, ученики и их прогресс, объявления, назначения, автоматические и собственные PDF-воркбуки, сроки, проверка выполнения, комментарии, редактор учебного контента и CSV-экспорт |
...
| Content | `/modules`, `/lessons`, `/tasks`, `/lessons/:id/workbook.pdf` | Уроки, задания и печатные A4-воркбуки |
...
Полный контракт 145 маршрутов: [backend/API_ROUTES.md](backend/API_ROUTES.md).
