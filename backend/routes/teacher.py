...
from models import (
    ...
    LearningStep, Lesson, MaterialUpload, Notification, PrerequisiteEdge, Skill, StudentProfile, Task, TaskAnswer,
    TeacherComment, User, db,
)
...
def create_assignment():
    ...
    assignment = Assignment(
        ...
        assignment_kind=str(data.get("assignment_kind") or ("corrective_micro" if requested_targets else "standard")),
