...
## Демонстрация оплаты с открытием Kaspi

Три MVP-тарифа отображаются по символической цене 1 ₸. По кнопке SANAQ пытается открыть
обычное приложение Kaspi без реквизитов и без создания банковского платежа. После возврата
платформа пять секунд имитирует обработку и активирует demo-подписку. Деньги не списываются;
это прозрачный hackathon-сценарий, а не интеграция Kaspi Pay. Настройка хоста и границы режима описаны в
